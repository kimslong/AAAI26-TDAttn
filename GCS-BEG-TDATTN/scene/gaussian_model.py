...
class GaussianModel:
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_t_features_dc=None, new_t_features_rest=None, new_GSweights=None, new_GSweights_cnt=None):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_GSweights = self.GSweights[selected_pts_mask].repeat(N, 1)  # 新增的GSweights更新
        new_GSweights_cnt = self.GSweights_cnt[selected_pts_mask].repeat(N, 1)

        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation, new_t_features_dc, new_t_features_rest,new_GSweights, new_GSweights_cnt)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_t_features_dc, new_t_features_rest, new_GSweights=new_GSweights, new_GSweights_cnt=new_GSweights_cnt)
